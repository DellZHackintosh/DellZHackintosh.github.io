var bloggie = (function () {
  ...
  var base = JSON.parse(get('./Bloggie/Core/base.json')),toCodePoint;
  ...
  var jslist = JSON.parse(get(base.jslistpath))
  var articlelist = JSON.parse(get(base.articlelistpath))
         ...
         if (Name) {
             ...
             if (articlelist[Name]) {
                 if (articlelist[Name].File) {
                     (bloggie.custom.command.Article || Article)(await get(articlelist[Name].File,null,true));
                 ...
                 if (base.SpecialPage[Name].action) {
                     ...
                     (bloggie.custom.command.Article || Article)(await get(base.SpecialPage[Name].file,null,true));
                 };
                 if (base.SpecialPage[Name].Title) document.title = base.SpecialPage[Name].Title;
             } else if (!Name) {
                 (bloggie.custom.command.Article || Article)(await get((base.SpecialPage['Main'].file || base.SpecialPage['Main'].action),null,true));
